...
/**
 * @typedef {{hvdApiUrl: string, hvdApiUrlNonDispo: string, engagementApiUrl:string, ouvertureCrmApiUrl:string, ouvertureCrmApiUrlProducers:string}} OuvertureThemeConfig
 */
...
export default defineConfigWithTheme({
  ...
  themeConfig: {
    ...
    hvdApiUrlNonDispo: env.VITE_HVD_NON_DISPO_API_URL ?? "",
